...
export function ImageAdjustmentProvider({ children, maxCacheSize = 100 }: ImageAdjustmentProviderProps) {
  ...
  return <ImageAdjustmentContext.Provider value={value}>{children}</ImageAdjustmentContext.Provider>;
}
