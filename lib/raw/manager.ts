...
import type { RawWorkerMessage, RawWorkerResponse } from "../../workers/raw-worker";
import type { RawProcessingResult, RawProcessorOptions } from "./processor";
...
export class RawProcessingManager {
  ...
  async processRawFile(fileBuffer: ArrayBuffer, options?: RawProcessorOptions): Promise<RawProcessingResult> {
