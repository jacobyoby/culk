...
import { Camera, FolderOpen, Info, Settings } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-br from-gray-900 to-black">
      <div className="max-w-4xl w-full space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground">Local-first RAW/JPEG culling with AI-powered features</p>
          {!isInstalled && <p className="text-sm text-yellow-500">Install as PWA for offline access</p>}
        </div>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="text-left">
                ...
                <p className="text-muted-foreground mt-1">Load RAW/JPEG from folders</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="text-left">
                ...
                <p className="text-muted-foreground mt-1">Review and rate images</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="text-left">
                ...
                <p className="text-muted-foreground mt-1">Export XMP sidecars</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="text-left">
                ...
                <p className="text-muted-foreground mt-1">Configure thresholds</p>
              </div>
            </div>
